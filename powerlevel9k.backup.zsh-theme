  ...
  if [[ -n "$POWERLEVEL9K_SHORTEN_DIR_LENGTH" ]]; then
    ...
    case "$POWERLEVEL9K_SHORTEN_STRATEGY" in
      ...
      iconify_then_truncate_from_right)
		  ...
		  typeset -A iconify_prefix_rules
		  iconify_prefix_rules=(
		  	# Pattern								# Icon Replacement
  	        '/Projects/1-Code Vault'        		$'\UE892'				#  # Binary Code Icon
  	        '/Users/mac'     						$'\UE8B9'				#  # Computer Icon
  	        '/Projects'         					$'\UE832'				#  # Open Book with -> Arrow
  	        # ICONIFY_PREFIX_DOWNLOADS     			$'\UE8B9'				#  # Computer Icon
  	        # ICONIFY_PREFIX_MOVIES     			$'\UE857'				#  # Video Camera Icon
  	      )
		  ...
		  for k in "${(@k)iconify_prefix_rules}"; do
			...
			if [[ "$stripped_pwd" =~ "$k" ]]; then
				...
				iconified_segment=" $before_segment $iconify_prefix_rules[$k] $path_separator"
